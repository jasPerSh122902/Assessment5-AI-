...
Maze::Maze()
{
	...
	TileKey map[Maze::HEIGHT][Maze::WIDTH] = {
		...
		{ w, w, _, _, _, _, _, _, _, _, _, w, s, _, _, _, _, _, w, _, w, w, _, w, _, _, w, w },
		{ w, _, _, w, _, _, w, _, _, _, _, _, p, _, w, _, w, _, _, _, _, _, _, w, w, _, _, w },
		{ w, _, _, _, w, _, _, _, w, _, w, _, w, _, w, _, _, _, w, _, w, _, w, _, _, w, _, w },
		{ w, _, w, _, _, _, w, w, _, _, w, _, _, _, _, _, w, _, _, _, w, _, _, w, _, _, _, w },
		{ w, _, _, w, _, w, w, _, w, _, _, _, w, _, w, w, w, _, w, _, _, _, w, _, _, w, w, w },
		{ w, w, _, w, _, _, _, _, _, _, w, _, _, _, _, w, _, _, _, w, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, w, w, _, w, _, w, w, _, w, _, _, _, w, _, _, _, _, w, _, w, _, _, w },
		{ w, _, w, w, _, _, _, _, w, _, _, _, _, _, _, w, _, _, _, _, w, _, _, _, _, w, _, w },
		{ w, _, w, _, w, _, _, _, _, _, _, _, w, _, w, _, w, _, w, _, _, _, w, w, _, w, w, w },
		...
		{ w, _, w, w, _, _, _, w, _, w, _, _, w, w, _, w, _, _, _, _, _, w, _, w, _, w, _, w },
		{ w, _, _, _, _, w, _, w, w, _, _, w, _, _, _, _, _, w, _, w, _, _, _, _, _, _, _, w },
		{ w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w },
	};

	m_player = new Player(0, 0, "Player", 200, 250);
	//Generate the map
	generate(map);
}
